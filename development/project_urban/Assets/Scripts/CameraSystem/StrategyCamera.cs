...
public class CameraRigController : MonoBehaviour
{
    ...
    [SerializeField, Tooltip("1 f�r RMB und 2 f�r MMB")] private int mouseButton = 1;
    ...
    void HandleZoom()  // �ndert die orthographic size der camera => dadurch, dass orthographic die entfernung der kamera ignoriert, muss man die size �ndern f�r einen zoom effekt
    {
    ...
    void HandlePan()
    {
        ...
        if (Input.GetMouseButton(mouseButton))
        {
            ...
            float dragSpeed = cam.orthographicSize * 0.4f; // abh�ngig vom Zoom-Level
